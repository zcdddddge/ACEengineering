...
static const uint16_t Smooth_L_PIN  = GPIO_Pin_3;
static const uint16_t Smooth_R_PIN  = GPIO_Pin_2;
...
/*平移左传感器*/
static u8 Return_Smooth_L_Val(void)
{
...
/*平移右传感器*/
static u8 Return_Smooth_R_Val(void)
{
